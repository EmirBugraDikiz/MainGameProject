...
public class CollectableItem : MonoBehaviour
{
    ...
    private bool isCollected = false; // Eþya toplandý mý kontrolü
    ...
    private void Collect(GameObject player)
    {
        ...
        if (collector != null)
        {
            ...
            // -----------------------------------------------------------
            // YENÝ EKLENEN KISIM: KÝLÝTLÝ KAPIYA HABER VERME
            // Sahnede bir KilitliKapi scripti varsa sayacý artýr
            if (KilitliKapi.instance != null)
            {
